...
enum opt_code
{
  ...
  OPT_mabi_ = 1268,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1269,             /* -mabort-on-noreturn */
  OPT_mandroid = 1270,                       /* -mandroid */
  OPT_mapcs = 1271,                          /* -mapcs */
  OPT_mapcs_frame = 1272,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1273,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1274,              /* -mapcs-stack-check */
  OPT_march_ = 1275,                         /* -march= */
  OPT_marm = 1276,                           /* -marm */
  OPT_masm_syntax_unified = 1277,            /* -masm-syntax-unified */
  OPT_mbe32 = 1278,                          /* -mbe32 */
  OPT_mbe8 = 1279,                           /* -mbe8 */
  OPT_mbig_endian = 1280,                    /* -mbig-endian */
  OPT_mbionic = 1281,                        /* -mbionic */
  ...
  OPT_mmusl = 1296,                          /* -mmusl */
  OPT_mneon_for_64bits = 1297,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1298,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1299,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1300,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1301,               /* -mprint-tune-info */
  OPT_mpure_code = 1302,                     /* -mpure-code */
  OPT_mrestrict_it = 1303,                   /* -mrestrict-it */
  OPT_msched_prolog = 1304,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1305,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1306,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1307, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1308,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1309,                         /* -mthumb */
  OPT_mthumb_interwork = 1310,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1311,                  /* -mtls-dialect= */
  OPT_mtp_ = 1312,                           /* -mtp= */
  OPT_mtpcs_frame = 1313,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1314,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1315,                         /* -mtune= */
  OPT_muclibc = 1316,                        /* -muclibc */
  OPT_munaligned_access = 1317,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1318,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1319,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1320,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1321,              /* -mword-relocations */
  OPT_n = 1322,                              /* -n */
  OPT_no_canonical_prefixes = 1323,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1324,              /* -no-integrated-cpp */
  OPT_no_pie = 1325,                         /* -no-pie */
  OPT_nocpp = 1326,                          /* -nocpp */
  OPT_nodefaultlibs = 1327,                  /* -nodefaultlibs */
  OPT_nolibc = 1328,                         /* -nolibc */
  OPT_nophoboslib = 1329,                    /* -nophoboslib */
  ...
  OPT_s = 1360,                              /* -s */
  OPT_save_temps = 1361,                     /* -save-temps */
  OPT_save_temps_ = 1362,                    /* -save-temps= */
  OPT_shared = 1363,                         /* -shared */
  OPT_shared_libgcc = 1364,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1365,               /* -shared-libphobos */
  ...
  OPT_std_c__2a = 1388,                      /* -std=c++2a */
  OPT_std_c__98 = 1389,                      /* -std=c++98 */
  OPT_std_c11 = 1390,                        /* -std=c11 */
  OPT_std_c17 = 1391,                        /* -std=c17 */
  /* OPT_std_c18 = 1392, */                  /* -std=c18 */
  /* OPT_std_c1x = 1393, */                  /* -std=c1x */
  OPT_std_c2x = 1394,                        /* -std=c2x */
  ...
  OPT_std_f2018 = 1402,                      /* -std=f2018 */
  OPT_std_f95 = 1403,                        /* -std=f95 */
  OPT_std_gnu = 1404,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1405, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1406, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1407,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1408,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1409,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1410, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1411, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1412,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1413,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1414,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1415,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1416, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1417, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1418,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1419, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1420,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1421,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1422, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1423, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1424,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1425, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1426, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1427, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1428, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1429, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1430,                     /* -std=legacy */
  OPT_symbolic = 1431,                       /* -symbolic */
  OPT_t = 1432,                              /* -t */
  OPT_time = 1433,                           /* -time */
  OPT_time_ = 1434,                          /* -time= */
  OPT_tno_android_cc = 1435,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1436,                 /* -tno-android-ld */
  OPT_traditional = 1437,                    /* -traditional */
  OPT_traditional_cpp = 1438,                /* -traditional-cpp */
  OPT_trigraphs = 1439,                      /* -trigraphs */
  OPT_u = 1440,                              /* -u */
  OPT_undef = 1441,                          /* -undef */
  OPT_v = 1442,                              /* -v */
  OPT_version = 1443,                        /* -version */
  OPT_w = 1444,                              /* -w */
  OPT_wrapper = 1445,                        /* -wrapper */
  OPT_x = 1446,                              /* -x */
  OPT_z = 1447,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
